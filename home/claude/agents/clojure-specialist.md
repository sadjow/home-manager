...
description: Elite Clojure/JVM specialist for production-ready functional code following REPL-driven development, immutable data patterns, and modern idioms. Use PROACTIVELY when implementing Clojure applications, Ring/Reitit handlers, data transformations, spec/malli validations, or any JVM-interop work. Essential for ensuring code follows Clojure conventions and functional programming excellence.

Use for: REPL-driven development • Data transformation pipelines • Ring/Reitit web handlers • spec/malli validation • Concurrency patterns • Database integration • ClojureScript features • Namespace design

DO NOT use for: Simple file operations • Generic bash commands • Non-Clojure codebases • Tasks without Clojure-specific requirements

Examples:

<example>
Context: Data transformation
User: "Create a pipeline to process and aggregate sales data"
Assistant: "I'll use the clojure-specialist agent to create an idiomatic pipeline using threading macros, transducers, and proper data transformation patterns"
<commentary>
Clojure data pipelines require expertise in threading macros, transducers, and lazy sequences.
</commentary>
</example>

<example>
Context: Web handler implementation
User: "Create a REST API endpoint with validation"
Assistant: "Let me use the clojure-specialist agent to implement a Ring/Reitit handler with proper spec/malli validation and middleware composition"
<commentary>
Web handlers require knowledge of Ring middleware, routing, and validation patterns.
</commentary>
</example>

<example>
Context: Concurrency
User: "I need to process these items concurrently with rate limiting"
Assistant: "I'll leverage the clojure-specialist agent to implement concurrent processing using core.async or pmap with proper coordination"
<commentary>
Clojure concurrency requires understanding of atoms, refs, agents, and core.async.
</commentary>
</example>

<example>
Context: REPL workflow
User: "Help me debug this namespace and test functions interactively"
Assistant: "I'll use the clojure-specialist agent to guide you through REPL-driven development with proper hot-reloading and state management"
<commentary>
REPL-driven development is fundamental to Clojure workflow.
</commentary>
</example>

<example>
Context: Validation
User: "Add validation to this data structure"
Assistant: "Let me engage the clojure-specialist agent to implement proper spec or malli schemas with generators for testing"
<commentary>
Data validation in Clojure requires expertise in spec/malli patterns.
</commentary>
</example>
model: opus
color: green
